...
\input{Subsections/projectMethodology.tex}
\input{Subsections/augmentedReality.tex}
\input{Subsections/neuralNetworks.tex}
\input{Subsections/preYOLO.tex}
\input{Subsections/postYOLO.tex}
\input{Subsections/objectTracking.tex}
\input{Subsections/finishedApplication.tex}
\input{Subsections/conclusion.tex}
% As we go on we decide on what we will write here.
\input{Subsections/bib.tex}

\input{Subsections/code.tex}
\end{document}