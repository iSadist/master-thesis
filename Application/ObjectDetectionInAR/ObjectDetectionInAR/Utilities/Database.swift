...
class Database
{
    ...
    func getInstructions(for furniture: Furniture) -> [Instruction]?
    {
        ...
        case "Nolmyra":
            ...
            nolmyraInstructions.append(AssembleInstruction(message: "Put these two pieces together", buttonText: "Next", firstItem: NOLMYRA_PIECE1, secondItem: NOLMYRA_PIECE2, assembledItem: NOLMYRA_CONJOINED_PIECE1))
            ...
            nolmyraInstructions.append(AssembleInstruction(message: "Put these two pieces together", buttonText: "Next", firstItem: NOLMYRA_CONJOINED_PIECE1, secondItem: NOLMYRA_PIECE1, assembledItem: NOLMYRA_CONJOINED_PIECE2))
            ...
            nolmyraInstructions.append(AssembleInstruction(message: "Put these two pieces together", buttonText: "Next", firstItem: NOLMYRA_CONJOINED_PIECE2, secondItem: NOLMYRA_PIECE2, assembledItem: NOLMYRA_CONJOINED_PIECE3))
            ...
            nolmyraInstructions.append(AssembleInstruction(message: "Put these two pieces together", buttonText: "Next", firstItem: NOLMYRA_CONJOINED_PIECE3, secondItem: NOLMYRA_SEAT, assembledItem: "nolmyra"))
    ...
    func getMeasurements(forPart part: String?) -> (SCNVector3)
    {
        ...
        case NOLMYRA_SCREW1:
            return SCNVector3(0.015, 0.1, 0.015)
        case NOLMYRA_SCREW2:
            return SCNVector3(0.015, 0.01, 0.015)
        default:
