...
class Database
{
    ...
    func getFurnitures() -> [Furniture]
    {
        ...
        collection.append(Furniture(name: "Säbövik", id: "603.034.81", description: "I den här kompletta sängen har madrassen bonnellresårer som ger hela kroppen ett fast stöd så att du kan sova gott hela natten. Och alla delar ryms i två platta paket och en rulle. Smidigt, eller hur?", icon: UIImage(named: "sabovik")!))
